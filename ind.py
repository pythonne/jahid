...
\033[1;91m  ♦♦♦CONTACT FACEBOOK / MRJK001♦♦♦
...
\033[1;96m               |_|   ༆JAHID°᭄ KINZAUpdated 0.3                   
...
jalan("   \033[1;91m SCRIPT EDITOR ༆JAHID°᭄KINZA ")

jalan("   \033[1;91m THIS IS ILLEGAL IM NOT RESPONSIBLE FOR THIS ")	

jalan("   \033[1;91m WIFI AND LOW SINGNAL USERZ USE ANY PROXY ")	

jalan("   \033[1;93m Welcome To ༆JAHID°᭄KINZA Creations ")

jalan("\033[1;97m•◈•──────────•◈•\033[1;96mJAHID ON FIRE \033[1;96m•◈•──────────•◈•")

CorrectUsername = "jahid"

CorrectPassword = "kinza"
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open https://www.facebook.com/MRJK001')

    else:

        print "Wrong Username"

        os.system('xdg-open https://www.facebook.com/ALEXA.ON.TABAHIIII')
...
def menu():
	...
	print "\033[1;32;40m[2] \033[1;33;40m══Update Tanu"																														
...
def pilih_super():
	...
	jalan('                    \033[1;97m ༆JAHID °᭄ KINZA start cloning Wait...')
...
\033[1;31;40m ●════════════════════════◄ Thanks To @itztanuhere ►════════════════════════●
